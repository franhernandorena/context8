    ...
    ### 1.1 Git status in the root or in the first son folder projects
    ```bash
    git status
    git log --oneline -15
    ...
    If `.context8/` does not exist: stop and run the new-project bootstrap (`project.md`) before continuing.
